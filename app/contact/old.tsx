        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty">
              ...
              opportunities, or to discuss partnerships. We'd love to hear from
              you.
            </p>
          </div>
        </div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="mt-6 p-4 bg-muted/50 rounded-lg">
                    <p className="text-sm text-muted-foreground">
                      <strong>Note:</strong> We typically respond to inquiries
                      within 24-48 hours during business days. For urgent
                      matters, please call our helpline directly.
                    </p>
                  </div>
                </CardContent>
              </Card>
